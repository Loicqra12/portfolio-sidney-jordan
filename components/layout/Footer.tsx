        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link href="#projects" className="block text-gray-400 hover:text-primary-400 transition-colors">
                Projets
              </Link>
              <Link href="#skills" className="block text-gray-400 hover:text-primary-400 transition-colors">
                Compétences
              </Link>
              <Link href="#contact" className="block text-gray-400 hover:text-primary-400 transition-colors">
                Contact
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">jordymelyer15@gmail.com</p>
            <p className="text-gray-400 mb-2">sidney.jordan@soutralideals.net</p>
            <p className="text-gray-400">+225 0748001042</p>
          </div>
        </div>
