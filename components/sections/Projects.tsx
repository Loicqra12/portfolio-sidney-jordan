              ...
              <div className="p-6 relative">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-800 group-hover:text-primary-600 transition-colors">{project.title}</h3>
                    <motion.span 
                      whileHover={{ scale: 1.05 }}
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  ...
                  {project.technologies.length > 3 && (
                    <motion.span 
                      whileHover={{ scale: 1.05 }}
                      className="px-3 py-1 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-600 rounded-full text-sm font-medium border border-gray-300"
                    >
                      +{project.technologies.length - 3}
                    </motion.span>
                  )}
                ...
                <div className="flex space-x-3">
                  {project.githubUrl && (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center space-x-2 text-sm text-gray-600 hover:text-primary-600 transition-colors bg-white/50 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/40 hover:border-primary-300 hover:bg-primary-50"
                    >
                      <Github size={16} />
                  ...
                  {project.liveUrl && (
                    <motion.a
                      ...
                      whileHover={{ scale: 1.05, x: 5 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center space-x-2 text-sm text-gray-600 hover:text-accent-600 transition-colors bg-white/50 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/40 hover:border-accent-300 hover:bg-accent-50"
                    >
