      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <div className="w-full h-96 bg-gradient-to-br from-primary-100 via-accent-100 to-purple-100 flex items-center justify-center relative">
                <motion.div
                  animate={{ 
                    rotate: 360,
                    scale: [1, 1.1, 1]
                ...
                />
                <span className="text-gray-500 text-lg font-medium">Votre photo ici</span>
              </div>
          ...
          >
            ...
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl bg-white/60 backdrop-blur-sm border border-white/40 p-6 shadow-lg hover:shadow-xl transition-all duration-300"
            >
              ...
              <div className="relative flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-3 text-gray-800 group-hover:text-blue-600 transition-colors">Mon parcours</h3>
            ...
            >
              ...
              <div className="relative flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-3 text-gray-800 group-hover:text-green-600 transition-colors">Ma philosophie</h3>
                  <p className="text-gray-600 leading-relaxed mb-4">
            ...
            >
              ...
              <div className="relative flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-3 text-gray-800 group-hover:text-orange-600 transition-colors">Ma vision</h3>
                  <p className="text-gray-600 leading-relaxed mb-4">
